...
class TaskStage(models.Model):
    ...
    _sql_constraints = [
        ('stage_name_uniq', 'UNIQUE (task_type_id, name)', 'Stage name must be uniq for task type'),
        ('stage_code_uniq', 'UNIQUE (task_type_id, code)', 'Stage code must be uniq for task type')
    ]
