...
class Project(models.Model):
    ...
    def _get_document_directory(self):
        return self.directory_id or self.env.ref('dms_project_budget.dms_directory_opportunity_directory')
    ...
    def _create_project_directory(self):
        for project in self:
            ...
            directory = self.env['dms.directory'].create({
                ...
                'parent_id': self.env.ref('dms_project_budget.dms_directory_opportunity_directory').id
            })
