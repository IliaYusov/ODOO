...
(
    SELECT
        ...
        'Дата контрактования' AS overdue,
        'Дата контрактования' AS overdue_in_7_days
    ...
    AND p.end_presale_project_month < CURRENT_DATE + INTERVAL '7' DAY
    UNION
    SELECT
        p.company_id,
        p.id AS project_id,        
    ...
    WHERE ps.end_presale_project_month < CURRENT_DATE + INTERVAL '7' DAY
    UNION
    SELECT
        p.company_id,
        p.id AS project_id,        
