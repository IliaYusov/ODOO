...
class License(models.Model):
    ...
    number_users = fields.Integer(string='Number Users', copy=True, default=1)
    ...
    date_start = fields.Date(string='Date Start', copy=True, default=fields.Date.context_today, required=True,
                             tracking=True)
    date_end = fields.Date(string='Date End', copy=True, default=fields.Date.context_today, tracking=True)
